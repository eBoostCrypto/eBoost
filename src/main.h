...
static const int64 MAX_MONEY = 100000000 * COIN; // eBoost: maximum of 100 million coins
...
inline CScript GetFoundationScript() {
	CBitcoinAddress address("eNgz9mTPLaatC6cAhHDGZz9yUPBVEqobZB");
	CScript script;
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > 100 * COIN * 1440 / 250; // eBoost: 576 blocks found a day. Priority cutoff is 1 eboost day / 250 bytes.
    }
